...
insert  into `course`(`InstituteId`,`ClassId`,`ClassName`,`ClassDes`) values (1,1,'First year',NULL),(1,2,'Second year',NULL),(1,3,'Third year',NULL),(1,4,'I year',NULL),(1,5,'II year',NULL),(1,6,'III year',NULL),(1,7,'IV year',NULL),(1,8,'V year',NULL),(2,9,'Firstyear',NULL),(2,10,'secondyear',NULL),(2,11,'I year',NULL),(2,12,'II year',NULL),(2,13,'III year',NULL),(2,14,'IV year',''),(2,15,'V year','');
...
insert  into `facultylist`(`InstituteId`,`FacultyId`,`TeacherId`,`SubjectId`,`Year`) values (NULL,1,1,1,'2023-2022'),(NULL,2,1,2,'2022-2021'),(NULL,3,1,5,'2021-2020'),(NULL,4,2,3,'2020-2019'),(NULL,5,2,4,'2019-2018'),(NULL,6,3,6,'2018-2017'),(NULL,7,4,7,'2017-2016'),(NULL,8,5,8,'2016-2015');
...
insert  into `hostelrecord`(`InstituteId`,`HostelRecordId`,`StudentId`,`HostelTermNo`,`HostelTermFee`,`TermPaidDate`,`PaidBy`,`Year`,`HostelTermDes`) values (1,1,1,1,1000,'2012-11-17','Lucky','2012-2013',''),(1,2,2,1,3000,'2012-11-17','zara','2012-2013',''),(1,3,3,2,3000,'2012-11-17','Eashwar','2012-2013',''),(1,4,4,1,4000,'2012-11-17','rebel','2012-2013',''),(1,5,5,3,2000,'2012-11-18','callen','2012-2013',''),(1,6,6,1,1000,'2013-10-15','Dollens','2012-2013',''),(1,7,7,1,900,'2013-11-07','Krishna','2012-2013',''),(1,8,8,1,5000,'2013-11-06','Eashwar','2012-2013',''),(1,9,9,0,9888,'2013-11-09','Sai','2012-2013',''),(1,11,11,1,999,'2013-11-14','Krishna sai','2012-2013',''),(1,12,12,1,9000,'2013-11-05','Eashwar','2012-2013',''),(2,13,13,2,890,'2013-11-10','Ediga','2012-2013',''),(2,14,14,1,1000,'2013-11-15','spartan','2012-2013',''),(2,15,15,2,90,'2013-11-27','alpha','2012-2013',''),(2,16,16,0,4000,'2013-12-16','rebel','2012-2013',''),(2,17,17,3,2000,'2013-12-16','dravid','2012-2013',''),(2,19,18,1,2000,'2013-12-16','dhoni','2012-2013',''),(2,22,19,1,1000,'2013-12-10','sehwag','2012-2013',NULL),(2,23,20,3,500,'2013-12-17','Nani','2012-2013',NULL),(2,24,21,0,2000,'2013-12-10','Symonds','2012-2013',NULL),(2,25,22,1,1000,'2013-12-20','sachin','2012-2013',NULL);
...
insert  into `subject`(`InstituteId`,`SubjectId`,`SubjectName`,`SubjectDes`) values (1,1,'software engineering',NULL),(1,2,'Java',NULL),(1,3,'Python',NULL),(1,4,'C++',NULL),(1,5,'ruby',NULL),(2,6,'cloud computing',NULL),(2,7,'ruby',NULL),(2,8,'C lan',NULL),(2,9,'Maths',NULL),(2,10,'electrical',NULL),(2,11,'cyber securty',NULL),(2,12,'Database','');
...
insert  into `totalperiods`(`InstituteId`,`TotalPeriodId`,`NoOfPeriods`,`SessionId`,`Year`) values (NULL,1,4,1,'2022-2023'),(NULL,2,4,2,'2022-2021');
